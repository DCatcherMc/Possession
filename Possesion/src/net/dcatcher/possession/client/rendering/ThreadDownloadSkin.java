...
public class ThreadDownloadSkin extends AbstractTexture
{
    ...
    public ThreadDownloadSkin(String par1Str, ResourceLocation par2ResourceLocation, IImageBuffer par3IImageBuffer)
    {
    ...
    public void func_110551_a(ResourceManager par1ResourceManager) throws IOException
    {
        ...
        {
            this.field_110561_e = new ThreadDownloadSkinINNER1(this);
    ...
    static String func_110554_a(ThreadDownloadSkin par0ThreadDownloadImageData)
    {
        return par0ThreadDownloadImageData.field_110562_b;
    }

    static IImageBuffer func_110555_b(ThreadDownloadSkin par0ThreadDownloadImageData)
    {
